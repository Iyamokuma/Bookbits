                            ...
                            <td class="px-4 py-3 font-medium text-slate-900">
                                ...
                                <div class="mt-1 flex flex-wrap gap-1">
                                    ...
                                    <?php if ((int) ($r['is_book_bundle'] ?? 0) === 1) : ?>
                                        <span class="rounded-full bg-purple-100 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-purple-700">Bundle</span>
                                    <?php endif; ?>
                                </div>
                            </td>
                    ...
                    <?php if ($totalPages > 1) : ?>
                        <div class="flex items-center gap-2">
                            ...
                            <?php if ($page < $totalPages) : ?>
                                <a href="<?= htmlspecialchars(BOOKBITS_BASE . '/admin/products.php?page=' . ($page + 1), ENT_QUOTES, 'UTF-8') ?>" class="rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm transition hover:border-brand/30 hover:text-brand">Next</a>
                            <?php else : ?>
